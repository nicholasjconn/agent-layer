...
If any are missing:
- Ask the user before creating them. If approved, copy `.agent-layer/templates/docs/<NAME>.md` into `docs/<NAME>.md` when available, preserving headings and markers.
