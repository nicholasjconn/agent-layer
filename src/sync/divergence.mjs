 ...
 * @returns {boolean}
 */
function shouldCheckAgent(enabledAgents, name) {
 ...
 */
export function collectMcpDivergences(parentRoot, catalog, enabledAgents) {
  /** @type {McpItem[]} */
  const items = [];
  const notes = [];
 ...
 */
export function collectDivergences(parentRoot, policy, catalog, enabledAgents) {
